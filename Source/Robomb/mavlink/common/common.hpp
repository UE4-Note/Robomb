...
enum class MAV_CMD : uint16_t
{
    ...
    NAV_VTOL_TAKEOFF=84, /* Takeoff from ground using VTOL mode including transition to forward flight. |Empty| Front transition heading, see VTOL_TRANSITION_HEADING enum.| Empty| Yaw angle in degrees. NaN for unchanged.| Latitude| Longitude| Altitude|  */
